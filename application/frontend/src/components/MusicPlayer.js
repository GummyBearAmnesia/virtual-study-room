...
export default class MusicPlayer extends Component {
  ...
  skipSong() {
    ...
    fetch(
      "https://virtual-study-room-unly.onrender.com/api/skip",
      requestOptions
    );
  }
  ...
  pauseSong() {
    ...
    fetch(
      "https://virtual-study-room-unly.onrender.com/api/pause",
      requestOptions
    );
  }
  ...
  playSong() {
    ...
    fetch(
      "https://virtual-study-room-unly.onrender.com/api/play",
      requestOptions
    );
  }
